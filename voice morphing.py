  ...
  "cells": [
    {
      ...
      "source": [
        "<a href=\"https://colab.research.google.com/github/digeesh00/Machine-learning/blob/main/voice%20morphing.py\" target=\"_parent\"><img src=\"https://colab.research.google.com/assets/colab-badge.svg\" alt=\"Open In Colab\"/></a>"
      ]
    },
    {
      "cell_type": "code",
    ...
    },
    {
      ...
      "source": [
        ...
        "\n",
        "epochs = 250 # @param {type:\"slider\", min:50, max:2000, step:10}\n",
        "\n",
        "#@markdown ---\n",
        "\n",
